...
public class RitardoCriteria extends AbstractORMCriteria {
	...
	public RitardoCriteria(Criteria criteria) {
		...
		appelloId = new LongExpression("appello.idAppello", this);
	...
	public PermessoEntrataCriteria createPermessoCriteria() {
		return new PermessoEntrataCriteria(createCriteria("permesso"));
	}
