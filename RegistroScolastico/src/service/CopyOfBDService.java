...
//			regAssPrimaA.getLibrettiAssenze().put(pieroRusso.getId(), librettoPieroRusso);
			...
			primaA.getRegistroAssenze().getLibrettiAssenze().put(pieroRusso.getId(), librettoPieroRusso);
			...
			assPieroRusso1.getAppelliAssenza().add(appello_1A_16_12_14);
...
//			domain.model.RegistroScolasticoPersistentManager.instance().getSession().save(ldomainmodelGiornoSettimanale);
	...
	public static void main(String[] args) {
		try {
			CopyOfBDService createRegistroScolasticoData = new CopyOfBDService();
			try {
