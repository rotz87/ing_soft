...
set _CLASSPATH=%CLASSPATH%;"lib\mysql-connector-java-5.1.33-bin.jar;lib\orm.jar"
...
"%_JAVACCMD%" -encoding UTF-8 -d %_CLASSES% -classpath %_CLASSPATH% %_SOURCEPATH%\domain\persistent\*.java %_SOURCEPATH%\ormsamples\*.java 
